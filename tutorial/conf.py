# -*- coding: utf-8 -*-
#
# tutorial documentation build configuration file
#
...
htmlhelp_basename = 'pyramidforhumans'
...
latex_documents = [
  ('index', 'pyramidforhumans.tex', 'Pyramid for Humans Documentation',
